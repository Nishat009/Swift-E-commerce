      ...
      <div className="space-y-6">
        ...
        <div className="border-b border-gray-100 dark:border-gray-800 pb-4">
          ...
          <p className="text-xs text-text-muted mt-1">
            Browse products you have saved to buy later or add to cart.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {items.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className="border border-gray-150/40 dark:border-gray-800/80 rounded-[32px] bg-white dark:bg-gray-900 overflow-hidden p-4 sm:p-5 shadow-xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-96 relative group"
                >
                  ...
                  <div className="mt-4 flex-1 space-y-1.5 min-w-0">
                    ...
                    <div className="flex items-baseline gap-2 pt-1">
                      <span className="text-sm font-black text-gray-905 dark:text-white">
                  ...
                  <div className="mt-5 pt-3 border-t border-gray-100 dark:border-gray-800">
                    <Button
                      ...
                      className="w-full bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100 text-white dark:text-zinc-950 font-bold py-2 px-4 rounded-full text-[10px] transition-all flex items-center justify-center gap-1.5 shadow-sm"
                    >
